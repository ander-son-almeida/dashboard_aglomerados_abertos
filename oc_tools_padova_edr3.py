...
#    masses = r.rand(isoc.size)*isoc['Mini']
    ...
    #sortear um fator entre 0.2 e 1, com maior probabilidade de ser 0.8
...
##############################################################################
    ...
    for filter in bands:
        ...
        mcomb = m1 - 2.5 * np.log10(1.0 + 10**(-0.4*(m2-m1))) #expressao para somar o fluxo - colocar na dissertacao
