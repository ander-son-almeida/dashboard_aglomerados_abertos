...
cluster = pd.read_csv('ander-son-almeida/dashboard_aglomerados_abertos/data/log-results-eDR3-MF_detalhada.csv', sep=';')

cluster = cluster.to_records()
#----------------------------------------------------------------------------------------------------            
#aplicando o filtro de aglomerados bons
filtro1 = pd.read_csv('ander-son-almeida/dashboard_aglomerados_abertos/filters\lista_OCs_classificados.csv', sep=';')
...
###############################################################################
# read memberships
members_ship = pd.read_csv('ander-son-almeida/dashboard_aglomerados_abertos/data/membership_data_edr3/membership_data_edr3/{}_data_stars.csv'.
